 ...
 */
final class Version20220414074308 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category_phase (category_id INT NOT NULL, phase_id INT NOT NULL, INDEX IDX_598E998212469DE2 (category_id), INDEX IDX_598E998299091188 (phase_id), PRIMARY KEY(category_id, phase_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
